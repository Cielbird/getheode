...
// MANNER
pub const CONT: u8 = 4;
pub const DELREL: u8 = 5;
pub const APPROX: u8 = 6;
pub const TAP: u8 = 7;
pub const TRILL: u8 = 8;
pub const NASAL: u8 = 9;
// LARYNGEAL
pub const VOI: u8 = 10;
pub const SPGL: u8 = 11;
pub const CONGL: u8 = 12;
// PLACE
// LABIAL
pub const LAB: u8 = 13;
pub const ROUND: u8 = 14;
pub const LABDENT: u8 = 15;
// CORONAL
pub const COR: u8 = 16;
pub const ANT: u8 = 17;
pub const DIST: u8 = 18;
pub const STRIDENT: u8 = 19;
pub const LATERAL: u8 = 20;
// DORSAL
pub const DOR: u8 = 21;
pub const HIGH: u8 = 22;
pub const LOW: u8 = 23;
pub const FRONT: u8 = 24;
pub const BACK: u8 = 25;
pub const TENSE: u8 = 26;
