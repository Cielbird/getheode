pub struct PhonoStringFormatOpts {
    // empty for now
}

impl Default for PhonoStringFormatOpts {
...
impl PhonoString {
    ...
    fn parse(input_str: &str, opts : &PhonoStringFormatOpts) -> Result<Self> {
        ...
        let mut result = PhonoString::new();
        let mut syllable_result = PhonoSyllable::new();
